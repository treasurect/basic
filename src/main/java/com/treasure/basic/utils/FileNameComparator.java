...
public class FileNameComparator implements Comparator<String> {
    ...
    public int compare(String str1, String str2) {
        ...
        int result = 0;
        //按照首字符 进行排序 升序 文字最后
//        String sub1 = str1.substring(0, 1);
//        String sub2 = str2.substring(0, 1);
//        if ((isChinese(sub1) && isChinese(sub2))||(
//            !isChinese(sub1) && !isChinese(sub2))){
//            str1 = EOUtils.toHanyuPinyin(str1);
//            str2 = EOUtils.toHanyuPinyin(str2);
//        } else if (!isChinese(sub1) && isChinese(sub2)){
//            return -1;
//        } else if (isChinese(sub1) && !isChinese(sub2)){
//            return 1;
//        }
